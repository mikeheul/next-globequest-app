...
const ContactPage = () => {
    return (
        <div className='relative h-screen flex flex-col items-center bg-slate-800'>
            ...
            <div className='absolute flex flex-col gap-8 justify-center items-center max-w-[80%] md:max-w-[50%] mt-[150px] text-white text-center'>
